...
namespace Application.Features.FindeksCreditRates.Commands.UpdateFindeksCreditRate
{
    public class UpdateFindeksCreditRateCommand : IRequest<UpdatedFindeksCreditRateDto>
    {
        ...
        public class UpdateFindeksCreditRateCommandHandler : IRequestHandler<UpdateFindeksCreditRateCommand, UpdatedFindeksCreditRateDto>
        {
            private readonly IFindeksCreditRateRepository _findeksCreditRateRepository;
            private readonly IMapper _mapper;
            private readonly FindeksCreditRateBusinessRules _findeksCreditRateBusinessRules;

            public UpdateFindeksCreditRateCommandHandler(IFindeksCreditRateRepository findeksCreditRateRepository, IMapper mapper, FindeksCreditRateBusinessRules findeksCreditRateBusinessRules)
            {
            ...
            public async Task<UpdatedFindeksCreditRateDto> Handle(UpdateFindeksCreditRateCommand request, CancellationToken cancellationToken)
            {
