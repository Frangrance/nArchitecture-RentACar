...
namespace Application.Features.FindeksCreditRates.Commands.CreateFindeksCreditRate
{
    public class CreateFindeksCreditRateCommand : IRequest<CreatedFindeksCreditRateDto>
    {
        ...
        public class CreateFindeksCreditRateCommandHandler : IRequestHandler<CreateFindeksCreditRateCommand, CreatedFindeksCreditRateDto>
        {
            private readonly IFindeksCreditRateRepository _findeksCreditRateRepository;
            private readonly IMapper _mapper;
            private readonly FindeksCreditRateBusinessRules _findeksCreditRateBusinessRules;

            public CreateFindeksCreditRateCommandHandler(IFindeksCreditRateRepository findeksCreditRateRepository, IMapper mapper, FindeksCreditRateBusinessRules findeksCreditRateBusinessRules)
            {
            ...
            public async Task<CreatedFindeksCreditRateDto> Handle(CreateFindeksCreditRateCommand request, CancellationToken cancellationToken)
            {
                ...
                CreatedFindeksCreditRateDto createdFindeksCreditRateDto = _mapper.Map<CreatedFindeksCreditRateDto>(createdFindeksCreditRate);
