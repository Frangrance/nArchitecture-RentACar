...
namespace Application.Features.FindeksCreditRates.Commands.DeleteFindeksCreditRate
{
    public class DeleteFindeksCreditRateCommand : IRequest<DeletedFindeksCreditRateDto>, ISecuredRequest
    {
                ...
                DeletedFindeksCreditRateDto>
        {
            ...
            public DeleteFindeksCreditRateCommandHandler(IFindeksCreditRateRepository findeksCreditRateRepository, IMapper mapper, FindeksCreditRateBusinessRules findeksCreditRateBusinessRules)
            {
            ...
            public async Task<DeletedFindeksCreditRateDto> Handle(DeleteFindeksCreditRateCommand request, CancellationToken cancellationToken)
            {
