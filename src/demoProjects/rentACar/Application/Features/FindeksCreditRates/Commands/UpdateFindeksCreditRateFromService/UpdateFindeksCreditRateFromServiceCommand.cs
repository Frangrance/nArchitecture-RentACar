...
public class UpdateFindeksCreditRateFromServiceCommand : IRequest<UpdatedFindeksCreditRateDto>
{
    ...
    public class UpdateFindeksCreditRateFromServiceCommandHandler : IRequestHandler<UpdateFindeksCreditRateFromServiceCommand, UpdatedFindeksCreditRateDto>
    {
        private readonly IFindeksCreditRateRepository _findeksCreditRateRepository;
        private readonly IFindeksService _findeksCreditRateService;
        private readonly IMapper _mapper;

        public UpdateFindeksCreditRateFromServiceCommandHandler(IFindeksCreditRateRepository findeksCreditRateRepository, IFindeksService findeksCreditRateService, IMapper mapper)
        {
        ...
        public async Task<UpdatedFindeksCreditRateDto> Handle(UpdateFindeksCreditRateFromServiceCommand request, CancellationToken cancellationToken)
        {
