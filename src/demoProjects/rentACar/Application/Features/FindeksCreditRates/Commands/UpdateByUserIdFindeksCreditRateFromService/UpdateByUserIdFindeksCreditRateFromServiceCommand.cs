...
{
    internal class UpdateByUserIdFindeksCreditRateFromServiceCommand : IRequest<UpdatedFindeksCreditRateDto>
    {
        public int UserId { get; set; }
        public string IdentityNumber { get; set; }

        public class UpdateFindeksCreditRateFromServiceCommandHandler : IRequestHandler<UpdateByUserIdFindeksCreditRateFromServiceCommand, UpdatedFindeksCreditRateDto>
        {
            ...
            public UpdateFindeksCreditRateFromServiceCommandHandler(IFindeksCreditRateRepository findeksCreditRateRepository, IFindeksService findeksCreditRateService, IMapper mapper, ICustomerService customerService)
            {
            ...
            public async Task<UpdatedFindeksCreditRateDto> Handle(UpdateByUserIdFindeksCreditRateFromServiceCommand request, CancellationToken cancellationToken)
            {
                ...
                UpdatedFindeksCreditRateDto updatedFindeksCreditRateDto = _mapper.Map<UpdatedFindeksCreditRateDto>(updatedFindeksCreditRate);
