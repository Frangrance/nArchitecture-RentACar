...
public class GetListFindeksCreditRateQuery : IRequest<FindeksCreditRateListModel>
{
    ...
    public class
        GetListFindeksCreditRateQueryHandler : IRequestHandler<GetListFindeksCreditRateQuery, FindeksCreditRateListModel>
    {
        ...
        public async Task<FindeksCreditRateListModel> Handle(GetListFindeksCreditRateQuery request, CancellationToken cancellationToken)
        {
            IPaginate<FindeksCreditRate> findeksCreditRates = await _findeksCreditRateRepository.GetListAsync(
                                                                  index: request.PageRequest.Page,
                                                                  size: request.PageRequest.PageSize);
            FindeksCreditRateListModel mappedFindeksCreditRateListModel = _mapper.Map<FindeksCreditRateListModel>(findeksCreditRates);
