...
public class UpdateIndividualCustomerCommand : IRequest<UpdatedIndividualCustomerDto>, ISecuredRequest
{
    ...
    public class
        UpdateIndividualCustomerCommandHandler : IRequestHandler<UpdateIndividualCustomerCommand, UpdatedIndividualCustomerDto>
    {
                                                               ...
                                                               CancellationToken cancellationToken)
        {
            ...
            UpdatedIndividualCustomerDto updatedIndividualCustomerDto = _mapper.Map<UpdatedIndividualCustomerDto>(updatedIndividualCustomer);
