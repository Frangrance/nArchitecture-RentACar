...
public class CreateIndividualCustomerCommand : IRequest<CreatedIndividualCustomerDto>, ISecuredRequest
{
    ...
    public class CreateIndividualCustomerCommandHandler : IRequestHandler<CreateIndividualCustomerCommand, CreatedIndividualCustomerDto>
    {
        ...
        public CreateIndividualCustomerCommandHandler(IIndividualCustomerRepository individualCustomerRepository, IMapper mapper, IndividualCustomerBusinessRules individualCustomerBusinessRules, IFindeksCreditRateService findeksCreditRateService)
        {
        ...
        public async Task<CreatedIndividualCustomerDto> Handle(CreateIndividualCustomerCommand request, CancellationToken cancellationToken)
        {
            ...
            CreatedIndividualCustomerDto createdIndividualCustomerDto = _mapper.Map<CreatedIndividualCustomerDto>(createdIndividualCustomer);
