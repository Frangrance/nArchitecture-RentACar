...
namespace Application.Features.CorporateCustomers.Commands.CreateCorporateCustomer
{
    public class CreateCorporateCustomerCommand : IRequest<CreatedCorporateCustomerDto>, ISecuredRequest
    {
        ...
        public class CreateCorporateCustomerCommandHandler : IRequestHandler<CreateCorporateCustomerCommand, CreatedCorporateCustomerDto>
        {
            ...
            public CreateCorporateCustomerCommandHandler(ICorporateCustomerRepository corporateCustomerRepository, IMapper mapper, CorporateCustomerBusinessRules corporateCustomerBusinessRules, IFindeksCreditRateService findeksCreditRateService)
            {
            ...
            public async Task<CreatedCorporateCustomerDto> Handle(CreateCorporateCustomerCommand request, CancellationToken cancellationToken)
            {
                ...
                await _findeksCreditRateService.Add(new FindeksCreditRate{ CustomerId = createdCorporateCustomer.CustomerId });

                CreatedCorporateCustomerDto createdCorporateCustomerDto = _mapper.Map<CreatedCorporateCustomerDto>(createdCorporateCustomer);
