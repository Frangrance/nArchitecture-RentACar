...
namespace Application.Services.RentalsIAdditionalServiceService
{
    public class RentalsAdditionalServiceManager : IRentalsAdditionalServiceService
    {
        ...
        public async Task<IList<RentalsAdditionalService>> AddManyByRentalIdAndAdditionalServices(int rentalId, IList<AdditionalService> additionalServices)
        {
            IList<RentalsAdditionalService> rentalsAdditionalServices = additionalServices.Select(a => new RentalsAdditionalService
            {
                RentalId = rentalId,
